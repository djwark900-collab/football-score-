...
type View = 'matches' | 'leagues' | 'standings' | 'admin' | 'settings' | 'game-details' | 'league-details' | 'team-details';
        ...
        <AnimatePresence mode="wait">
          {view === 'matches' && (
            ...
            >
                ...
                {leagues.map(league => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedLeagueId === league.id ? "bg-blue-600 text-white shadow-lg shadow-blue-200" : "bg-white text-gray-500 hover:bg-gray-50"
                    )}
                  >
              ...
              <section>
                <h2 className="text-lg font-bold mb-4">Recent & Upcoming</h2>
                <div className="grid gap-4">
             ...
             >
               {leagues.map(league => (
                 <div 
                   ...
                   className="p-4 bg-white rounded-3xl border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow cursor-pointer"
                 >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{league.country || 'International'}</p>
                    </div>
